...
# Create a session state variable to store the chat session, with context as initial history.
if "chat" not in st.session_state:
    st.session_state.chat = model.start_chat(history=[{"role": "system", "parts": [task]}])

# Create a session state variable to store the chat session.
if "chat" not in st.session_state:
